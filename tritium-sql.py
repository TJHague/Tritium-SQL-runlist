...
elif abs(float(caget("haBDSPOS_2"))-target_encoder)<50.0:
    target = caget("haBDSSELECT.TWST").rstrip()
elif abs(float(caget("haBDSPOS_3"))-target_encoder)<50.0:
    target = caget("haBDSSELECT.THST").rstrip()
elif abs(float(caget("haBDSPOS_4"))-target_encoder)<50.0:
    target = caget("haBDSSELECT.FRST").rstrip()
elif abs(float(caget("haBDSPOS_5"))-target_encoder)<50.0:
    target = caget("haBDSSELECT.FVST").rstrip()
elif abs(float(caget("haBDSPOS_6"))-target_encoder)<50.0:
    target = caget("haBDSSELECT.SXST").rstrip()
elif abs(float(caget("haBDSPOS_7"))-target_encoder)<50.0:
    target = caget("haBDSSELECT.SVST").rstrip()
elif abs(float(caget("haBDSPOS_8"))-target_encoder)<50.0:
    target = caget("haBDSSELECT.EIST").rstrip()
elif abs(float(caget("haBDSPOS_9"))-target_encoder)<50.0:
    target = caget("haBDSSELECT.NIST").rstrip()
elif abs(float(caget("haBDSPOS_10"))-target_encoder)<50.0:
    target = caget("haBDSSELECT.TEST").rstrip()
elif abs(float(caget("haBDSPOS_11"))-target_encoder)<50.0:
    target = caget("haBDSSELECT.ELST").rstrip()
elif abs(float(caget("haBDSPOS_12"))-target_encoder)<50.0:
    target = caget("haBDSSELECT.TVST").rstrip()
elif abs(float(caget("haBDSPOS_13"))-target_encoder)<50.0:
    target = caget("haBDSSELECT.TTST").rstrip()
elif abs(float(caget("haBDSPOS_14"))-target_encoder)<50.0:
    target = caget("haBDSSELECT.FTST").rstrip()
elif abs(float(caget("haBDSPOS_15"))-target_encoder)<50.0:
